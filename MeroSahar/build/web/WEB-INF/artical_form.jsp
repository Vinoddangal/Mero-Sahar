...
<div class="pages clearfix">
	<div class="hotel-reg-contain">
            <form method="post" action="post_artical" class="hotel-form" enctype="multipart/form-data">
		...
		<div class="pages main-conten">
				...
				<div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="photo" class="form-control-file" onchange="displayPhoto(this)">
                                    </div>
		...
		<div class="form-group">
			...
			<select name="type" id="type" class="form-control">
				<option v="typealue="documentary">Documentary</option>

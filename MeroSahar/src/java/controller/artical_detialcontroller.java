 ...
 * @author Rukesh
 */
@WebServlet(name = "artical_detialcontroller", urlPatterns = {"/myartical","/singleartical","/editartical"})
public class artical_detialcontroller extends HttpServlet {
        ...
        switch (servletPath) {
            ...
            case "/myartical":
             ...
             case "/editartical":
                ...
                ArticalTbl articaldetial = artical.findArticalTbl(new Integer(id));
                //System.out.println(articalList.toString());
                request.setAttribute("artical",articaldetial);
                location = "/WEB-INF/edit_artical.jsp";
                break;
            default:
                location = "/WEB-INF/myartical.jsp";

 ...
 * @author Rukesh
 */
@WebServlet(name = "dashboardcontroller", urlPatterns = {"/dashboard","/home", "/indexpage"})
public class dashboardcontroller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest req, HttpServletResponse res)
        ...
        EntityManagerFactory emf = (EntityManagerFactory) req.getServletContext().getAttribute("mero_sahar_emf");
        ...
        dispatchRequest(req, res, dashboardURL);
    }
    ...
    private void dispatchRequest(HttpServletRequest req, HttpServletResponse res, String dashboardURL) throws ServletException, IOException {
        req.getRequestDispatcher(dashboardURL).forward(req, res);
    }
